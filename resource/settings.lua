...
RegisterCommand('ox_lib', function()
    ...
    local notification_audio, notification_position, primaryColor, primaryShade, locale = table.unpack(input)
    ...
    exports.ox_banking:setTheme({ primaryColor = primaryColor, primaryShade = primaryShade })
...
CreateThread(function()
    Wait(500)
    exports.ox_banking:setTheme({ primaryColor = settings.primaryColor, primaryShade = settings.primaryShade })
    SendNUIMessage({
        action = 'updateColorSettings',
        data = {
